...
POSTS = {
    "2026-10-서울-무료축제": {
        ...
        "sub": "Three things nobody tells you.",
        "cover": "잠수교-사진/한강-전경/4062103.jpg",
        # 🪪 **이 묶음에 실제로 쓴 사진의 촬영자만 적는다.**
        #    안 쓴 사람을 적는 것도 틀린 표기다 — 처음에 「두드림」을 넣어 뒀는데
        #    한 번 뺐다가 **BTS 벤치 카드를 넣으면서 다시 넣었다**(2708760 촬영자).
        #    표지 4062103 정규진 · 잠수교 3537888 서문교 · 서울숲 3098337 임태원 ·
        #    BTS 벤치 2708760 두드림.
        "credit": ("출처 : ⓒ한국관광콘텐츠랩\n"
                   "촬영 : 정규진 · 서문교 · 임태원 · 두드림"),
        "items": [
            ...
            {
                # 사장님이 직접 고치셨다 (2026-09-16): *"황금빛으로 물든 공원 / 가을의 파란하늘"*
                #
                # 🚨 **사진 하늘이 하얗다고 사진을 바꾸지 않는다.**
                #    내가 파란 하늘이 나온 3098336 으로 갈아 끼웠더니 사장님이 되돌리셨다:
                #      *"그런 팩트 상관없어. 보는 차이니."*
                #    광고 문구는 **사진 설명이 아니다.** 「가을의 파란 하늘」은 손님 머릿속에
                #    떠올리게 하는 말이지, 이 사진을 묘사하는 말이 아니다.
                #    📌 사진은 **그림이 좋은 것**으로 고른다. 글에 맞추느라 좋은 사진을
                #       버리면 손해다 — 손가락을 멈추게 하는 건 글이 아니라 그림이다.
                #    (영상에서 이미 정한 선이다 — `docs/잠수교-릴스-대본.md` 의
                #     *"사진하고 틀리다고 고소하냐고"*.)
                "place": "SEOUL FOREST",
                "line": ["A park washed in gold.", "Under an autumn blue sky."],
                "when": "Through October",
                "photo": "서울숲-사진/가을/3098337.jpg",
                "note": "박람회 사진은 갤러리에 없다 — 같은 자리(서울숲) 실사",
            },
            {
                # 사장님 (2026-09-16): *"비티에스 벤치도 언급해"*
                # 축제가 아니라 **장소**다. 그래도 넣는다 — 외국 손님에게는 축제보다 세다.
                # 이 묶음은 「10월의 서울」이지 「10월의 축제」가 아니다.
                #
                # 📜 **명판에 실제로 새겨진 글자를 그대로 옮겼다.**
                #    사진(2708760)에 「우린 서로의 야경 / 서로의 달 — RM」이라고 찍혀 있다.
                #    지어낸 말이 아니라 **현장에 있는 글**이다 — 여기는 분위기 자리가 아니라
                #    인용이므로 한 자도 바꾸지 않는다.
                # ⚠️ 노래 제목·앨범은 안 적는다. 명판에 없다.
                #
                # 🚩 **이건 결정이 끝난 것이다. 다시 붙들지 말 것.**
                #    내가 「2021년 사진이라 지금도 있는지 모른다」며 카드를 빼자고 했다.
                #    사장님: *"장소 날짜 정도지."* → **그대로 간다.**
                #    카드가 말하는 것은 **장소와 날짜뿐**이고, 위치를 못 박지 않았다.
                #    사진도 명판이 실제로 찍힌 관광공사 실사다. 지어낸 것이 하나도 없다.
                #    📌 「정확도」는 **손님이 보고 움직이는 것**(날짜·요일·값·주소)에 쓰는 잣대다.
                #       여기에 그 잣대를 들이대면 아무 카드도 못 만든다.
                "place": "BTS BENCH · SEOUL FOREST",
                "line": ['"Each other\'s night view,', 'each other\'s moon."', "— RM"],
                "when": "Any day · free",
                "photo": "서울숲-사진/가을/2708760.jpg",
                "note": "서울숲 BTS 가사 명판 (촬영 두드림)",
            },
        ],
    },
