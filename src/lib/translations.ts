...
const translations: Record<Language, Translations> = {
  ko: {
    ...
    cityPickerNote: '지금은 서울입니다. 도시를 하나씩 늘려 갑니다.',
    cityGroupBig: '대도시',
    cityGroupProvince: '도',
  ...
  en: {
    ...
    cityPickerNote: 'Seoul is ready. We add cities one at a time.',
  ...
  ja: {
    ...
    cityPickerNote: '今はソウルです。都市を一つずつ増やしていきます。',
    cityGroupBig: '大都市',
    cityGroupProvince: '道',
    cityReady: '今すぐ見られます',
    citySoon: '準備中',
  ...
  zh: {
    ...
    cityPickerNote: '目前是首尔。我们会一座城市一座城市地增加。',
    cityGroupBig: '大城市',
  ...
  'zh-TW': {
    ...
    cityPickerNote: '目前是首爾。我們會一座城市一座城市地增加。',
    cityGroupBig: '大城市',
    cityGroupProvince: '道（省）',
    cityReady: '現在就能看',
    citySoon: '籌備中',
  ...
  vi: {
    ...
    cityPickerNote: 'Hiện đã có Seoul. Chúng tôi thêm từng thành phố một.',
  ...
  es: {
    ...
    cityPickerNote: 'Seúl ya está. Añadimos ciudades una a una.',
  ...
  fr: {
    ...
    cityPickerNote: 'Séoul est prête. Nous ajoutons les villes une par une.',
  ...
  de: {
    ...
    cityPickerNote: 'Seoul ist da. Weitere Städte kommen nach und nach dazu.',
  ...
  ru: {
    ...
    cityPickerNote: 'Сеул уже открыт. Города добавляем по одному.',
  ...
  id: {
    ...
    cityPickerNote: 'Seoul sudah siap. Kami menambah kota satu per satu.',
  ...
  th: {
    ...
    cityPickerNote: 'ตอนนี้มีโซล เราจะเพิ่มเมืองทีละแห่ง',
