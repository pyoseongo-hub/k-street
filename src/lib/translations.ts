...
const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    luggageLinkLabel: 'Station facilities',
  ...
  vi: {
    ...
    luggageLinkLabel: 'Tiện ích tại ga',
  ...
  es: {
    ...
    luggageLinkLabel: 'Servicios de la estación',
  ...
  fr: {
    ...
    luggageLinkLabel: 'Services de la station',
  ...
  de: {
    ...
    luggageLinkLabel: 'Stationsausstattung',
  ...
  ru: {
    ...
    luggageLinkLabel: 'Услуги станции',
  ...
  id: {
    ...
    luggageLinkLabel: 'Fasilitas stasiun',
  ...
  th: {
    ...
    luggageLinkLabel: 'สิ่งอำนวยความสะดวกในสถานี',
