...
const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    seasonTitle: 'Spring Summer Fall Winter … and Seoul',
  ...
  vi: {
    ...
    seasonTitle: 'Xuân Hạ Thu Đông … và Seoul',
  ...
  es: {
    ...
    seasonTitle: 'Primavera Verano Otoño Invierno … y Seúl',
  ...
  fr: {
    ...
    seasonTitle: 'Printemps Été Automne Hiver … et Séoul',
  ...
  de: {
    ...
    seasonTitle: 'Frühling Sommer Herbst Winter … und Seoul',
  ...
  ru: {
    ...
    seasonTitle: 'Весна Лето Осень Зима … и Сеул',
  ...
  id: {
    ...
    seasonTitle: 'Semi Panas Gugur Dingin … dan Seoul',
  ...
  th: {
    ...
    seasonTitle: 'ใบไม้ผลิ ร้อน ใบไม้ร่วง หนาว และโซล',
