  ...
  return (
    <div className="place-directions">
      ...
      <div className="map-directions-row">
        ...
        {/* 🚫 **그림표를 넣었다가 반나절 만에 다시 뺐다** (2026-09-15). 남겨 두는 기록이다.
         *
         *  넣은 이유 — 사장님: *"텍스트 짐보관 아이콘으로. 화장실 휠체어나 엘리베이터
         *  이걸로"*, *"짐보관도 넣어야해"*. 그래서 🛅♿🛗🚻 를 달았다. 이 상자의
         *  크로미움에서는 넷 다 또렷하게 떴고, 12개 언어 잘림 검사도 전부 통과했다.
         *
         *  뺀 이유 — 사장님 폰에서 **안 보였다**: *"아이콘 안보여"*.
         *
         *  🚨 **왜 안 보였나 — 이모지도 글꼴이다.**
         *     🛅(U+1F6C5)·🛗(U+1F6D7)은 **Emoji 12.0(2019)** 이라 좀 된 폰에는
         *     그 글자가 아예 없다. 없으면 빈칸이나 네모로 뜬다. 같은 줄의 📍는
         *     잘 보이는데 — 그건 2010년부터 있던 글자라서다.
         *     → **단추에 쓸 이모지는 「오래된 것」만.** 그리고 새것이든 옛것이든
         *       **내 화면에서 보인다고 손님 화면에서 보이는 게 아니다.**
         *       이건 브라우저 검사로 못 잡는다(러너에는 최신 글꼴이 깔려 있다).
         *
         *  ⚠️ 이 저장소가 단추 그림으로 물린 것이 **이번이 두 번째**다 —
         *     2026-09-05에도 「아이콘 몬지 모르겠어」로 전부 뺐다(HomeSwitch 주석).
         *     한 번은 뜻이 안 읽혀서, 한 번은 글자가 없어서. **다시 달지 말 것.**
         *
