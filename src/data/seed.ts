...
export const FESTIVALS: Place[] = [
  ...
  { id: id(), gu: "구로구", category: "festival", name: "구로G페스티벌", confirmed: true },
  ...
  { id: id(), gu: "도봉구", category: "festival", name: "도봉별빛축제", confirmed: true },
  { id: id(), gu: "동대문구", category: "festival", name: "동대문페스티벌", note: "공연예술축제 — 거리예술·음악공연", confirmed: true },
  { id: id(), gu: "동작구", category: "festival", name: "도심 속 바다축제", confirmed: true },
  { id: id(), gu: "마포구", category: "festival", name: "서울와우북페스티벌", note: "책문화예술축제, 구의 유일한 축제는 아닐 수 있음", confirmed: true },
  ...
  { id: id(), gu: "서초구", category: "festival", name: "서초뮤직앤아트페스티벌", confirmed: true },
  { id: id(), gu: "성동구", category: "festival", name: "서울숲 JAZZ페스티벌 · 세계민속춤축제", startMonth: 9, endMonth: 9, dateLabel: "9월 말", confirmed: true },
  { id: id(), gu: "성북구", category: "festival", name: "성북 세계음식축제 누리마실 · 다다페스타", confirmed: true },
...
export const MUSEUMS: Place[] = [
  ...
  { id: id(), gu: "서대문구", category: "museum", name: "5곳 — 이름 미확인", confirmed: false },
  { id: id(), gu: "은평구", category: "museum", name: "3곳 — 이름 미확인", confirmed: false },
  { id: id(), gu: "강서구", category: "museum", name: "3곳 — 이름 미확인", confirmed: false },
  { id: id(), gu: "영등포구", category: "museum", name: "3곳 — 이름 미확인", confirmed: false },
  { id: id(), gu: "노원구", category: "museum", name: "5곳 — 이름 미확인", confirmed: false },
  { id: id(), gu: "구로구", category: "museum", name: "1곳 — 이름 미확인", confirmed: false },
  { id: id(), gu: "서초구", category: "museum", name: "9곳 — 이름 미확인", confirmed: false },
  { id: id(), gu: "강동구", category: "museum", name: "확인 필요", confirmed: false },
  { id: id(), gu: "강북구", category: "museum", name: "확인 필요", confirmed: false },
  { id: id(), gu: "관악구", category: "museum", name: "확인 필요", confirmed: false },
  { id: id(), gu: "광진구", category: "museum", name: "확인 필요", confirmed: false },
  { id: id(), gu: "도봉구", category: "museum", name: "확인 필요", confirmed: false },
  { id: id(), gu: "동대문구", category: "museum", name: "확인 필요", confirmed: false },
